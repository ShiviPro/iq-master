...
public class MapQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "mapQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "map_quiz";
    ...
    public MapQuizDBHandler(Context context) {
