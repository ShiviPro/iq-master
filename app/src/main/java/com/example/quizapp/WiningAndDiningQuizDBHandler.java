...
public class WiningAndDiningQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "winingAndDiningQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "wining_and_dining_quiz";
    ...
    public WiningAndDiningQuizDBHandler(Context context) {
