...
public class UltimateArtQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "ultimateArtQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "ultimate_art_quiz";
    ...
    public UltimateArtQuizDBHandler(Context context) {
