...
public class HistoryOfWarQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "historyOfWarQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "history_of_war_quiz";
    ...
    public HistoryOfWarQuizDBHandler(Context context) {
