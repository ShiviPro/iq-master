...
public class AllAboutAsiaQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "asiaQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "all_about_asia_quiz";
    ...
    public AllAboutAsiaQuizDBHandler(Context context) {
