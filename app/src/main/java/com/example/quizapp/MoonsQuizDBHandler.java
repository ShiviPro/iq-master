...
public class MoonsQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "moonsQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "moons_quiz";
    ...
    public MoonsQuizDBHandler(Context context) {
