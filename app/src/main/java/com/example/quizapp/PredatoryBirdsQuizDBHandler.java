...
public class PredatoryBirdsQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "predatoryBirdsQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "predatory_birds_quiz";
    ...
    public PredatoryBirdsQuizDBHandler(Context context) {
