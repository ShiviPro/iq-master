...
public class IntroQuizDBHandler extends SQLiteOpenHelper {

    // Defining basic DB info
    private static final String DB_NAME = "introQuizDB";

    private static final int DB_VERSION = 1;

    private static final String TABLE_NAME = "intro_quiz";
    ...
    public IntroQuizDBHandler(Context context) {
